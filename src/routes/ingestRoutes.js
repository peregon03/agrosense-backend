...
router.post("/", async (req, res) => {
  try {
    const { device_id, api_key, temperature_c, humidity_pct } = ingestSchema.parse(req.body);
    ...
    await pool.query(
      `INSERT INTO sensor_readings (sensor_id, temperature_c, humidity_pct)
       VALUES ($1, $2, $3)`,
      [sensor_id, temperature_c ?? null, humidity_pct ?? null]
    );
